...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_combo_menu(self):
        ...
        icon1 = QIcon("firmware_update.jpg")
        icon2 = QIcon("label_change.png")
    ...
    def init_gauge(self, gauge):
        ...
        gauge.setNeedleColor(255, 0, 0, 255)

        gauge.setEnableBarGraph(True) # 겉부분 초록색부터 빨간색 색상
        gauge.enable_fine_scaled_marker = False # 작은 마커
        gauge.needle_scale_factor = 0.9

        gauge.valueNeedleSnapzone = 0.9
    ...
    def change_stacked_widget(self, index):
        ...
        self.combo_menu.setCurrentIndex(-1) # icon은 그대로 메모리에서는 가지고있기
