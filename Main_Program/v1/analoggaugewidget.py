    ...
    def setGaugeTheme(self, Theme=1):
        if Theme == 0 or Theme == None:
            ...
            self.needle_center_bg = [
                                    ...
                                    [0, QColor(35, 35, 35, 255)],
                                    [0.16, QColor(40, 40, 40, 255)],
                                    [0.225, QColor(45, 45, 45, 255)],
                                    [0.423963, QColor(40, 40, 40, 255)],
                                    [0.580645, QColor(35, 35, 35, 255)],
                                    [0.792627, QColor(40, 40, 40, 255)],
                                    [0.935, QColor(45, 45, 45, 255)],
                                    [1, QColor(40, 40, 40, 255)]
            ]
            ...
            self.outer_circle_bg = [
                ...
                [0.0645161, QColor(0, 0, 0, 255)],
                [0.37788, QColor(0, 0, 0, 255)],
                [1, QColor(0, 0, 0, 255)]
