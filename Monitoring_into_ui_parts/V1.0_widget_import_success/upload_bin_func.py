...
class UiMainWindow(QtWidgets.QMainWindow, form_window):
    def __init__(self):
        ...
        self.each_sensor_format = uic.loadUi("each_sensor.ui")
        self.each_sensor_format1 = uic.loadUi("each_sensor.ui")
        self.each_sensor_format2 = uic.loadUi("each_sensor.ui")
        self.each_sensor_format3 = uic.loadUi("each_sensor.ui")
        # self.each_sensor_format = uic.loadUiType("each_sensor.ui")
        self.gridlayout_sensors.addWidget(self.each_sensor_format,0,0)
        self.gridlayout_sensors.addWidget(self.each_sensor_format1,0,1)
        self.gridlayout_sensors.addWidget(self.each_sensor_format,0,2)
        self.gridlayout_sensors.addWidget(self.each_sensor_format2,1,0)
        self.gridlayout_sensors.addWidget(self.each_sensor_format,1,1)
        self.gridlayout_sensors.addWidget(self.each_sensor_format3,1,2)
        self.gridlayout_sensors.addWidget(self.each_sensor_format,2,0)
        ###초기화 잘해주기
